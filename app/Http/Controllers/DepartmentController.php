...
class DepartmentController extends Controller
{
    ...
    {
        return Inertia::render('Setup/Department');
    }
    ...
    public function store(Request $request)
    {
        $request->validate(
            [
                'title' => 'required|string|max:100|unique:departments',
            ]
        );
    ...
    public function update(Request $request, Department $department)
    {
        $request->validate(
            [
                'title' => ['required', 'string', 'max:100', Rule::unique(Department::class)->ignore($department)],
            ]
        );

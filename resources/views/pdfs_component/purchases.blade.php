...
<body>
    ...
    <div class="float-start">
        <span class="fw-bold text-uppercase h3">purchases record</span>
        <br>
        <!-- company's details -->
    ...
    <div class="float-end">
        <img src="https://con.smavegroup.com/build/assets/favicon.55fcebd6.png" class="mt-3" height="50">
        <br>
        <br>
        <small>{{ $date }}</small>
    </div>
